...
if (isset($_POST['newName']) || isset($_POST['newSecondaryContact']) ||  isset($_POST['newPlace']) || isset($_POST['newCode']) || isset($_POST['newAge']) || isset($_POST['lab']) || isset($_POST['newDate']) || isset($_POST['enter']) || isset($_POST['newContact'])) {
  ...
  $lab=$_POST['lab'];
  $no=$_POST['no'];
  $sql="UPDATE lab SET name='$newName',place='$newPlace',age='$newAge',date='$newDate',code='$newCode',contact='$newContact',secondarycontact='$newSecondaryContact',lab='$lab' WHERE no='$no'";
  ...
  echo "<form method='post'><button name='list' class='btn btn-info' formaction='lab_display.php'>Back</button></form>";
