...
<textarea name="lab" rows="8" cols="80" ><?php echo $row['lab']; ?></textarea>

<input type="hidden" name="no" value="<?php echo $row['no']; ?>"><br>

<!--   <input type="submit" name="" value="enter" formaction="sample.php"> -->

<button type="submit" class="btn btn-primary" name="enter" formaction="lab_edit_enter.php"> Update </button>

<!--<tr>
  <td><button type="submit" name="list" formaction="consultation_list.php">Daily Consultation List</button></td>
</tr> -->

  <button class="btn btn-danger" formaction="lab_display.php"> Cancel </button>
