...
if (isset($_POST['search-btn'])) {
  ...
  $query = "SELECT * FROM previouspatients WHERE name LIKE '%$search%' OR secondarycontact LIKE '%$search%' OR place LIKE '%$search%' OR  gender LIKE '%$search%' OR age LIKE '%$search%'
