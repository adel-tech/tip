...
if (isset($_GET['edit'])) {
  ...
  $no=$_GET['edit'];
  $res=mysqli_query($conn,"SELECT * FROM previouspatients WHERE no='$no'");
...
<button type="button" name="button"><a href="login.php">Back to Registration</a></button></p>-->
...
/*if (isset($_POST['newName']) || isset($_POST['newCode']) || isset($_POST['newAge']) || isset($_POST['newDate']) || isset($_POST['enter']) || isset($_POST['newContact'])) {
 ...
 <form class="form-group"  method="post">
  ...
  Name<input type="text" class="form-control col-sm-4"  name="newName" value="<?php echo $row['name']; ?>"> <br>

  Place<input type="text" class="form-control col-sm-4" name="newPlace" value="<?php echo $row['place']; ?>"> <br>

Token<input type="number" class="form-control col-sm-4" name="newCode" value="<?php echo $row['code']; ?>"> <br>

Age<input type="number" class="form-control col-sm-4" name="newAge" value="<?php echo $row['age']; ?>"> <br>

Date<input type="text" class="form-control col-sm-4" name="newDate" value="<?php echo $row['date']; ?>"> <br>

Contact<input type="number" class="form-control col-sm-4" name="newContact" value="<?php echo $row['contact']; ?>"> <br>

Secondary Contact<input type="number" class="form-control col-sm-6" name="newSecondaryContact" value="<?php echo $row['secondarycontact']; ?>"><br>

  <input type="hidden" name="no" value="<?php echo $row['no']; ?>"><br>

   <input type="submit" class="btn btn-primary col-sm-4" name="" value="Update" formaction="previous_patients_rough.php">

<!--<tr>
  <td><button type="submit" name="list" formaction="consultation_list.php">Daily Consultation List</button></td>
</tr>-->

 <button type="cancel" class="btn btn-danger col-sm-4" name="cancel" formaction="all.php">  Cancel </button>
