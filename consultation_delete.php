...
if (isset($_GET['consultation_delete'])) {
  ...
  if ($delete) {
    ...
    ?> <form  method="post">
      <button type="submit" name="list" formaction="total_consultation.php">Back to consultation list</button>
       <button type="submit" name="list" formaction="login.php">Back to Registration</button>
    </form>
   ...
   ?><form  method="post">
    ...
    <a href="login.php"><button> Back to Registration </button></a>  <?php
  }
}
?>
</div>
