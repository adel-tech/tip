...
if (isset($_POST['newName']) || isset($_POST['newSecondaryContact']) || isset($_POST['newPlace']) || isset($_POST['newCode']) || isset($_POST['newAge']) || isset($_POST['newDate'])
 || isset($_POST['lab']) || isset($_POST['enter']) || isset($_POST['newContact'])) {
  ...
  $no=$_POST['no'];
  $foreignkey=$_POST['no'];
  $sql="INSERT INTO lab (name,place,age,code,lab,contact,secondarycontact,foreignkey) VALUES ('$newName','$newPlace','$newAge','$newCode','$lab','$newContact','$newSecondaryContact','$foreignkey')";
