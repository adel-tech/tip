 ...
 if ($numberOfResults >= 0) {
   ...
   <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
       <div class="card border-3 border-top border-top-primary">
           <div class="card-body">
               <h5 class="text-muted">Total Consulted Patients</h5>
...
<form class="" method="post" autocomplete="on">
  Search<input type="text" class="form-control col-sm-4" name="consultation-search" placeholder="search for a patient" id="search_text">
  <button type="submit" class="btn btn-primary" name="consultation-search-btn" formaction="consultation_search.php">Search</button>
