 ...
 if ($numberOfResults >= 0) {
   ...
   <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
       <div class="card border-3 border-top border-top-primary">
           <div class="card-body">
               <h5 class="text-muted">Today's Consulted Patients</h5>
...
<form class="" method="post" autocomplete="on">
  Search<input type="text" class="form-control col-sm-6" name="search" placeholder="search for a patient" id="search_text">
  <button type="submit" class="btn btn-primary" name="search-btn" formaction="todays_consulted_search.php">Search</button>
...
<tr>
  ...
  <th> <?php echo "Consultation Time"; ?> </th>
   ...
   while ($row = mysqli_fetch_assoc($result)) { ?>
     <?php //The results are displayed in a table  ?>
              ...
              <tr>
                ...
                <td>
                 <a href="consultation_pdf.php?consultation_pdf= <?php echo $row['no']; ?>" target="new">Print Details</a>
               </td>

      <!--        <td>
                <a href="reciept-result.html">print details</a>
              </td> -->
