...
$showall = "SELECT * FROM previouspatients;";
...
if ($numberOfResults >= 0) {  ?>
  ...
  <?php
  echo "<h4>"."You have"." ".$numberOfResults." "."total registered patients"."</h4>"."<br>";
 // echo "<button type='submit' name='search' formaction='search.php'>Search</button>"."<br>";

?>
<form class="" method="post" autocomplete="on">
 Search<input type="text" id="search_text" class="form-control col-sm-4" name="search" placeholder="search for a patient">
 <button type="submit" class="btn btn-primary " name="search-btn" formaction="search.php" >Search</button>
 <div id="results">
  ...
  while ($row = mysqli_fetch_assoc($result)) { ?>
    ...
    <!--    <table id="table-data" class="table table-bordered "> -->
             ...
             <tr>
               ...
               <td>
                <a href="previous_patients_delete.php?delete= <?php echo $row['no']; ?>">delete</a>
                </td>
                <td>
                 <a href="previous_patients_edit.php?edit= <?php echo $row['no']; ?>">edit </a>
                 </td>
                <td>
                 <a href="previous_patients_consultation.php?previous_patients_consultation= <?php echo $row['no']; ?>">
                    <button type="button" name="previous_patients_consultation">consultation</button> </a>
            </td>
            <td>
             <a href="previous_patients_lab.php?previous_patients_lab= <?php echo $row['no']; ?>"> <button type="button" name="previous_patients_lab">Enter Lab</button> </a>
        </td>

        <!--    <a href="consultation_edit.php?consultation_edit= <?php //echo $row['no']; ?>"> -->
