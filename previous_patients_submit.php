...
if (strlen($contact)==10 && strlen($secondarycontact)==10) {
  ...
  $add = "INSERT INTO previouspatients (name,place, age, code,gender,contact,secondarycontact) VALUES ('$name','$place' , '$age', '$code','$gender','$contact','$secondarycontact');";

  $result = mysqli_query($conn,$add);

  if ($result) { ?>
    <h5><?php echo "<h3>"."Patient Successfully Recorded"."</h3>"; ?></h5>
...
<?php
  ...
  echo "<h1>"."Check Contact info Again"."</h1>";
}
