 ...
 if ($numberOfResults >= 0) {
   ...
   <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
       <div class="card border-3 border-top border-top-primary">
           <div class="card-body">
               <h5 class="text-muted">Lab Reports Available</h5>
...
<form class="" method="post" autocomplete="on">
  Search<input type="text" class="form-control col-sm-4" name="lab-search" placeholder="search for a patient" id="search_text" required>
  <button type="submit" class="btn btn-primary" name="lab-search-btn" formaction="lab_search.php">Search</button>
   ...
   while ($row = mysqli_fetch_assoc($result)) { ?>
     <?php //The results are displayed in a table  ?>
              ...
              <tr>
                ...
                <td>
                 <a href="lab_delete.php?lab_delete= <?php echo $row['no']; ?>">Delete</a>
                </td>
                <td>
                 <a href="lab_edit.php?lab_edit= <?php echo $row['no']; ?>">Edit</a>
                </td>
                <td>
                 <a href="lab_pdf.php?lab_pdf= <?php echo $row['no']; ?>" target="new">Print Details</a>
                </td>
