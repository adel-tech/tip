...
$showall = "select * from redo where date like concat('%' , CURDATE() , '%');";
...
if ($numberOfResults >= 0) {
  ...
  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
      <div class="card border-3 border-top border-top-primary">
          <div class="card-body">
              <h5 class="text-muted">Today's Registered Patients</h5>
  ...
  <?php
  echo "Today "." ".$numberOfResults." "."patients have registered"."<br>";
...
<form class="" method="post" autocomplete="on">
 ...
 <button type="submit" name="search-btn" formaction="todays_patients_search.php" >Search</button>
 <div id="results">
...
<tr>
 ...
 <th> <?php echo "contact"; ?> </th>
  <th> <?php echo "secondarycontact"; ?> </th>
 <th> <?php echo "gender"; ?> </th>
 <th> <?php echo "delete"; ?> </th>
 <th> <?php echo "edit"; ?> </th>
 <th> <?php echo "consultation"; ?> </th>
 <th> <?php echo "lab reports"; ?> </th>
</tr>
<?php
  ...
  while ($row = mysqli_fetch_assoc($result)) { ?>
    ...
    <!--    <table id="table-data" class="table table-bordered "> -->
            ...
            <td>
             <a href="lab.php?lab= <?php echo $row['no']; ?>"> <button type="button" name="lab">Enter Lab</button> </a>
        </td>
