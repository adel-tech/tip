...
if (isset($_POST['lab-search-btn'])) {
  //Searched Data is stored in a variable.
  $search = mysqli_real_escape_string($conn,$_POST['lab-search']);
  //Query to perform the search operation
  $query = "SELECT * FROM lab WHERE name LIKE '%$search%'
  OR secondarycontact LIKE '%$search%'
  OR age LIKE '%$search%'
...
?>
  ...
  <tr>
    ...
    <td>
     ...
     <td>
      <a href="lab_pdf.php?lab_pdf= <?php echo $row['no']; ?>" target="new">Print</a>
     </td>
  </tr>
