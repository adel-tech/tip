...
<?php
if (isset($_GET['previous_patients_consultation'])) {

  $no=$_GET['previous_patients_consultation'];
...
<label> Consultation Details </label> <br>
<textarea name="consultation" rows="8" cols="80" placeholder="Enter consultation details" required ></textarea><br>

  <!-- <input type="submit" name="" value="enter" formaction="enter.php"> -->

<button type="submit" name="enter" formaction="enter.php" class="btn btn-primary col-lg-3"> Enter </button>
