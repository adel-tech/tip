...
if (isset($_POST['newName']) ||  isset($_POST['secondarycontact']) || isset($_POST['newPlace']) || isset($_POST['newCode']) || isset($_POST['newAge']) || isset($_POST['consultation']) ||
isset($_POST['newDate']) || isset($_POST['enter']) || isset($_POST['newContact'])) {
  ...
  $no=$_POST['no'];
  $sql="UPDATE daily SET name='$newName',place='$newPlace',age='$newAge',date='$newDate',code='$newCode',contact='$newContact',consultation='$consultation',secondarycontact='$newSecondaryContact' WHERE no='$no'";
  ...
  echo "<form method='post'><button name='list' class='btn btn-info' formaction='total_consultation.php'>Back</button></form>";
