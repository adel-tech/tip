...
if (isset($_POST['newName']) || isset($_POST['secondarycontact']) || isset($_POST['newPlace']) || isset($_POST['newCode']) || isset($_POST['newPlace']) || isset($_POST['newAge']) || isset($_POST['newDate']) || isset($_POST['Update']) || isset($_POST['newContact'])) {
  ...
  $no=$_POST['no'];
  $sql="UPDATE previouspatients SET name='$newName',place= '$newPlace' ,age='$newAge',date='$newDate',code='$newCode',contact='$newContact',secondarycontact='$newSecondaryContact' WHERE no='$no'";
...
//      WHERE redo.no='$no' AND (redo.name=daily.name AND redo.name=lab.name) AND (redo.place=daily.place AND redo.place=lab.place)";
  ...
  echo "<form method='post'> <button name='display' formaction='previous_patients_view.php'> Back </button> </form>";
