...
<body>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="card border-3 border-top border-top-primary">
                                        <div class="card-body">
                                            <h5 class="text-muted">Total Registered Patients</h5>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="card border-3 border-top border-top-primary">
                                        <div class="card-body">
                                            <h5 class="text-muted"> Patients Consulted Today</h5>
                                            <div class="metric-value d-inline-block">
                                                <!-- select * from redo where date like concat('%' , CURDATE() , '%');  -->
                                                <h1 class="mb-1"> <?php
                                                        include 'connection.php';
  ...
  <input type="text" id="search_text" name="search" placeholder="Search Patient" required >
