...
Token<input type="number" class="form-control col-sm-6" name="newCode" value="<?php echo $row['code']; ?>" readonly> <br>
...
<textarea name="consultation" rows="8" cols="80" ><?php echo $row['consultation']; ?></textarea>

<input type="hidden" name="no" value="<?php echo $row['no']; ?>"><br>

<!--   <input type="submit" name="" value="enter" formaction="sample.php"> -->

<button type="submit" class="btn btn-primary" name="enter" formaction="sample.php"> Update </button>

<!--<tr>
  <td><button type="submit" name="list" formaction="consultation_list.php">Daily Consultation List</button></td>
</tr> -->

  <button class="btn btn-danger" formaction="total_consultation.php"> Cancel </button>
