...
if (isset($_GET['delete'])) {
  $no = $_GET['delete'];
  $deleteQuery = "DELETE FROM previouspatients WHERE no=$no;";

  $delete = mysqli_query($conn,$deleteQuery);
  if ($delete) {
    echo "<h1>"."Record Deleted"."</h2>";
    ?>
    <form class="form-inline"  method="post">
      <button type="submit" class="form-control col-sm-4" name="display" formaction="previous_patients_view.php">Back to Previous Patients</button>
    <!--  <button type="submit" class="form-control" name="display" formaction="login.php">Back to Registration</button> -->
    </form>
